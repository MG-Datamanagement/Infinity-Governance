...
export const connectors: Connector[] = [
  ...
  },
  {
    ...
    name: "CassandraDB",
    description:
      "Import Tables, Keyspaces, and column schemas from Cassandra.",
    bgColor: "bg-white",
    borderColor: "border-gray-100",
    icon: "cassandra",
  },
...
export const dataSources: DataSource[] = [
  {
    ...
    ingestionLogs: [
      { time: '10:45 AM', message: 'Schema extraction completed', status: 'success' },
      { time: '10:44 AM', message: 'Connection established successfully', status: 'success' },
      { time: '10:42 AM', message: 'Starting incremental sync', status: 'info' },
    ],
  },
  {
    id: 'my_cust_2_db',
    ...
    ingestionLogs: [
      { time: '10:45 AM', message: 'Schema extraction completed for customers', status: 'success' },
      { time: '10:44 AM', message: 'Connection established successfully', status: 'success' },
      { time: '10:42 AM', message: 'Starting incremental sync', status: 'info' },
      { time: 'Yesterday', message: 'Failed to sync view sales_materialized', status: 'error' },
    ],
  },
  {
    id: 'postgres_db',
    ...
    ingestionLogs: [
      ...
      { time: '10:38 AM', message: 'Connection established', status: 'success' },
  ...
  },
  {
    ...
    ingestionLogs: [
      { time: 'Yesterday', message: 'Failed to connect to warehouse cluster', status: 'error' },
      { time: 'Yesterday', message: 'Retrying connection (attempt 3/3)', status: 'error' },
...
export const datasetsBySource: DatasetsBySource = {
  postgres_db: [
    { id: 'customers', name: 'customers', hasPII: true, type: 'Table', rows: '12.4k', columns: 18, size: '2.4 MB', lastSync: '2 hours ago', status: 'Healthy' },
    { id: 'orders', name: 'orders', hasPII: false, type: 'Table', rows: '450.2k', columns: 24, size: '156 MB', lastSync: '2 hours ago', status: 'Healthy' },
    { id: 'transactions', name: 'transactions', hasPII: true, type: 'Table', rows: '1.2M', columns: 32, size: '450 MB', lastSync: '2 hours ago', status: 'Healthy' },
    { id: 'products', name: 'products', hasPII: false, type: 'Table', rows: '850', columns: 12, size: '1.2 MB', lastSync: '2 hours ago', status: 'Healthy' },
    { id: 'inventory_logs', name: 'inventory_logs', hasPII: false, type: 'Table', rows: '89k', columns: 8, size: '12 MB', lastSync: '2 hours ago', status: 'Warning' },
    { id: 'customer_ltv_view', name: 'customer_ltv_view', hasPII: true, type: 'View', rows: null, columns: 5, size: null, lastSync: '2 hours ago', status: 'Healthy' },
    { id: 'daily_sales_report', name: 'daily_sales_report', hasPII: false, type: 'View', rows: null, columns: 10, size: null, lastSync: '2 hours ago', status: 'Healthy' },
    { id: 'audit_logs', name: 'audit_logs', hasPII: false, type: 'Table', rows: '2.5M', columns: 15, size: '890 MB', lastSync: '10 mins ago', status: 'Healthy' },
  ],
  mongo_db: [
    { id: 'users', name: 'users', hasPII: true, type: 'Table', rows: '5.2k', columns: 14, size: '1.1 MB', lastSync: '2 days ago', status: 'Healthy' },
    { id: 'sessions', name: 'sessions', hasPII: false, type: 'Table', rows: '180k', columns: 8, size: '42 MB', lastSync: '2 days ago', status: 'Healthy' },
    { id: 'events', name: 'events', hasPII: false, type: 'Table', rows: '3.4M', columns: 20, size: '780 MB', lastSync: '2 days ago', status: 'Warning' },
  ],
  my_cust_2_db: [
    { id: 'customers', name: 'customers', hasPII: true, type: 'Table', rows: '38k', columns: 22, size: '8.1 MB', lastSync: '2 days ago', status: 'Healthy' },
    { id: 'sales', name: 'sales', hasPII: false, type: 'Table', rows: '1.1M', columns: 15, size: '230 MB', lastSync: '2 days ago', status: 'Healthy' },
  ],
  my_cust_warehouse: [
    { id: 'fact_sales', name: 'fact_sales', hasPII: false, type: 'Table', rows: '2.2M', columns: 28, size: '512 MB', lastSync: '2 days ago', status: 'Error' },
  ],
};
...
export const datasetDetails: Record<string, DatasetDetail> = {
  ...
  orders: {
    ...
    keyFields: [
      ...
      { name: 'status', description: 'Order status (pending / shipped / delivered)' },
    ],
    freshness: '2h ago',
    volume: '450.2k',
    qualityScore: '100%',
