...
const DatasetDetailPage: React.FC<DatasetDetailPageProps> = ({
  ...
  //       const aiResults = response?.results || [];

  //       // Map results by column name
  //       const aiMap = aiResults.reduce((acc: any, item: any) => {
  //         acc[item.column_name] = item;
  //         return acc;
  //       }, {});

  //       // Merge AI result into existing columns
  //       const updatedColumns = catalogData?.columns.map((col: any) => {
  //         const ai = aiMap[col.name];
