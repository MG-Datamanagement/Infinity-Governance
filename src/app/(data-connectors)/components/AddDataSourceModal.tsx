...
const Step2: React.FC<{
  ...
  config: { uri: string; username: string; password: string; schemaInference: boolean; randomSampling: boolean; maxSchemaSize: string; yamlMode: boolean };
    ...
    {config.yamlMode ? (
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            type="text"
            value={config.uri || "mongodb+srv://Md-Ashif:XDkD9CJaBBPBmKKr@cluster0.8z8om.mongodb.net/Patient360DB"}
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              type="text"
              value={config.username || "Md-Ashif"}
          ...
          <div>
            ...
            <input
              type="password"
              value={config.password || "XDkD9CJaBBPBmKKr"}
