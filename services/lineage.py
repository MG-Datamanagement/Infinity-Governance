...
ODS_MOCK_ALL_BOOKINGPASSENGER = CentricLineageNode(
    ...
    columns=[
        ...
        ColumnInfo(id="ods-bp-06", name="cancellation_rate",    data_type="SchemaFieldDataTypeClass({'type': NumberTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-bp-07", name="first_booking_date",   data_type="SchemaFieldDataTypeClass({'type': DateTypeClass({})})",   is_nullable=True),
        ColumnInfo(id="ods-bp-08", name="last_booking_date",    data_type="SchemaFieldDataTypeClass({'type': DateTypeClass({})})",   is_nullable=True),
        ColumnInfo(id="ods-bp-09", name="days_since_last_book", data_type="SchemaFieldDataTypeClass({'type': NumberTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-bp-10", name="created_date",         data_type="SchemaFieldDataTypeClass({'type': StringTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-bp-11", name="modified_date",        data_type="SchemaFieldDataTypeClass({'type': StringTypeClass({})})", is_nullable=True),
    ],
    tags=[_PII_TAG],
...
ODS_MOCK_ALL_BOOKING = CentricLineageNode(
    ...
    columns=[
        ...
        ColumnInfo(id="ods-b-07", name="preferred_origin",  data_type="SchemaFieldDataTypeClass({'type': StringTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-b-08", name="preferred_dest",    data_type="SchemaFieldDataTypeClass({'type': StringTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-b-09", name="booked_via_agent",  data_type="SchemaFieldDataTypeClass({'type': BooleanTypeClass({})})",is_nullable=True),
        ColumnInfo(id="ods-b-10", name="agent_id",          data_type="SchemaFieldDataTypeClass({'type': NumberTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-b-11", name="created_date",      data_type="SchemaFieldDataTypeClass({'type': StringTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-b-12", name="modified_date",     data_type="SchemaFieldDataTypeClass({'type': StringTypeClass({})})", is_nullable=True),
    ],
    tags=[_PII_TAG],
...
ODS_MOCK_ALL_PASSENGERFEE = CentricLineageNode(
    ...
    columns=[
        ...
        ColumnInfo(id="ods-pf-07", name="created_date",          data_type="SchemaFieldDataTypeClass({'type': StringTypeClass({})})", is_nullable=True),
...
ODS_MOCK_ALL_AGENT = CentricLineageNode(
    ...
    columns=[
        ...
        ColumnInfo(id="ods-ag-02", name="preferred_agent_name", data_type="SchemaFieldDataTypeClass({'type': StringTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-ag-03", name="agency_name",          data_type="SchemaFieldDataTypeClass({'type': StringTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-ag-04", name="agent_type",           data_type="SchemaFieldDataTypeClass({'type': StringTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-ag-05", name="agent_code",           data_type="SchemaFieldDataTypeClass({'type': StringTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-ag-06", name="country",              data_type="SchemaFieldDataTypeClass({'type': StringTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-ag-07", name="is_active",            data_type="SchemaFieldDataTypeClass({'type': BooleanTypeClass({})})",is_nullable=True),
        ColumnInfo(id="ods-ag-08", name="created_date",         data_type="SchemaFieldDataTypeClass({'type': StringTypeClass({})})", is_nullable=True),
...
ODS_MOCK_ODS_PROFILES_DOWNSTREAM = CentricLineageNode(
    ...
    columns=[
        ...
        ColumnInfo(id="ods-prof-09", name="primary_email",        data_type="SchemaFieldDataTypeClass({'type': StringTypeClass({})})", is_nullable=True),
        ...
        ColumnInfo(id="ods-prof-12", name="sms_opt_in",           data_type="SchemaFieldDataTypeClass({'type': BooleanTypeClass({})})",is_nullable=True),
        ...
        ColumnInfo(id="ods-prof-19", name="total_bookings",       data_type="SchemaFieldDataTypeClass({'type': NumberTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-prof-20", name="cancellation_count",   data_type="SchemaFieldDataTypeClass({'type': NumberTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-prof-21", name="total_revenue",        data_type="SchemaFieldDataTypeClass({'type': NumberTypeClass({})})", is_nullable=True),
        ColumnInfo(id="ods-prof-22", name="total_fare",           data_type="SchemaFieldDataTypeClass({'type': NumberTypeClass({})})", is_nullable=True),
